...
Answer- Decision trees are prone to overfit
...
Answer-Statistical learning theory and computational learning theory
# 48 Identify the difficulties with the k-nearest neighbor algorithm
Answer-Curse of dimensionality and Calculate the distance of test case for all training cases.
...
Answer-neither feature nor number of groups is known
...
# 55 What is called the average squared difference between classifier predicted output and actual 
output?
Answer-Mean squared error
# 56 Logistic regression is a ........... regression technique that is used to model data having a ............ 
outcome.
...
# 60 Supervised learning and unsupervised clustering both require which is correct according to the 
statement.
